function(buildInfo PREFIX)
    ...
    set(${PREFIX}_BUILD_DATE  ${DATE} PARENT_SCOPE)
...
function(parseVersion PREFIX)
    ...
    if(${GIT_VERSION} MATCHES "(([0-9]*)\.([0-9]*)\.([0-9]*)(.*))-([0-9]*)-g([0-9A-Fa-f]*)(-dirty)?")
        ...
        set(${PREFIX}_VERSION_PROJECT ${CMAKE_MATCH_2}.${CMAKE_MATCH_3}.${CMAKE_MATCH_4}  PARENT_SCOPE)
        set(${PREFIX}_VERSION_FULL    ${CMAKE_MATCH_1}+${CMAKE_MATCH_6}.${CMAKE_MATCH_7}${CMAKE_MATCH_8} PARENT_SCOPE)

        message(STATUS "${PREFIX} Building version ${CMAKE_MATCH_1}+${CMAKE_MATCH_6}.${CMAKE_MATCH_7}${CMAKE_MATCH_8}")
